...
export const courses: Course[] = [
  ...
  {
    slug: "Design Visualization Essential", categorySlug: "civil-courses", name: "Design Visualization Essential", desc: "Creates dynamic 3D designs.", duration: "40 Hours", cat: "Mech", image: imgMech,
  ...
  {
    slug: "V-Ray Essential", categorySlug: "civil-courses", name: "V-Ray Essential", desc: "Generates realistic rendered images.", duration: "40 Hours", cat: "Mech", image: imgCatia,
  ...
  {
    slug: "SketchUp Essential", categorySlug: "civil-courses", name: "SketchUp Essential", desc: "Visualizes basic building concepts.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Revit Architecture Essential", categorySlug: "civil-courses", name: "Revit Architecture Essential", desc: "Builds precise BIM models.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "STAAD .Pro Essential", categorySlug: "civil-courses", name: "STAAD .Pro Essential", desc: "Tests structural load safety.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Construction Management using MSP", categorySlug: "civil-courses", name: "Construction Management using MSP", desc: "Manages site project timelines.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Max for Engineers/Architects Essential", categorySlug: "civil-courses", name: "Max for Engineers/Architects Essential", desc: "Builds cinematic 3D walkthroughs.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "ETABS Essential", categorySlug: "civil-courses", name: "ETABS Essential", desc: "Analyzes high-rise building safety.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "MSP with PPM Concepts Essential", categorySlug: "civil-courses", name: "MSP with PPM Concepts Essential", desc: "Manages multi-project corporate portfolios.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Building Estimation and Costing with Simulation", categorySlug: "civil-courses", name: "Building Estimation and Costing with Simulation", desc: "Estimates precise construction budgets.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "ProSteel Essential", categorySlug: "civil-courses", name: "ProSteel Essential", desc: "Designs heavy steel structures.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Ansys Civil Essential", categorySlug: "civil-courses", name: "Ansys Civil Essential", desc: "Predicts concrete structural stress.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "AECOsim Essential", categorySlug: "civil-courses", name: "AECOsim Essential", desc: "Unifies multi-disciplinary BIM designs.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "AutoCAD Civil 3D Essential", categorySlug: "civil-courses", name: "AutoCAD Civil 3D Essential", desc: "Designs roads and infrastructure.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "MicroStation Essential", categorySlug: "civil-courses", name: "MicroStation Essential", desc: "Maps large infrastructure networks.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "MX Road Essential", categorySlug: "civil-courses", name: "MX Road Essential", desc: "Designs highway alignment geometry.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "RCC Detailing Essential", categorySlug: "civil-courses", name: "RCC Detailing Essential", desc: "Creates rebar layout drawings.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Proficient in AutoCAD for Civil Engineers and Architects", categorySlug: "civil-courses", name: "Proficient in AutoCAD for Civil Engineers and Architects", desc: "Drafts 2D floor blueprints.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Proficient in Revit", categorySlug: "civil-courses", name: "Proficient in Revit", desc: "Advanced BIM 3D modeling.", duration: "80 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Proficient in STAAD.Pro", categorySlug: "civil-courses", name: "Proficient in STAAD.Pro", desc: "Advanced structural dynamic analysis.", duration: "80 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Proficient in Primavera for Construction Management", categorySlug: "civil-courses", name: "Proficient in Primavera for Construction Management", desc: "Master enterprise project planning.", duration: "24 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Proficient in Interior & Architectural Design", categorySlug: "civil-courses", name: "Proficient in Interior & Architectural Design", desc: "Designs aesthetic indoor spaces.", duration: "80 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Proficient in Construction Management using Primavera & MSP", categorySlug: "civil-courses", name: "Proficient in Construction Management using Primavera & MSP", desc: "Complete project scheduling control.", duration: "64 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Proficient in 3D BIM", categorySlug: "civil-courses", name: "Proficient in 3D BIM", desc: "Performs spatial clash detection.", duration: "40 Hours", cat: "Mech", image: imgSolidworks,
  ...
  {
    slug: "Proficient in BIM for Transportation Design", categorySlug: "civil-courses", name: "Proficient in BIM for Transportation Design", desc: "Models transit network infrastructure.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in BIM for Structural Design", categorySlug: "civil-courses", name: "Proficient in BIM for Structural Design", desc: "Connects calculations to modeling.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in 5D BIM", categorySlug: "civil-courses", name: "Proficient in 5D BIM", desc: "Integrates time and cost.", duration: "80 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "GD&T-Essential", categorySlug: "mechanical-courses", name: "GD&T Essential", desc: "Standardizes manufacturing engineering tolerances.", duration: "16 Hours", cat: "CAD", image: imgAutocad,
  ...
  {
    slug: "Creo Essential", categorySlug: "mechanical-courses", name: "Creo Essential", desc: "Builds 3D parametric assemblies.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "NX CAD Essential", categorySlug: "mechanical-courses", name: "NX CAD Essential", desc: "Models complex car bodies.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "SolidWorks Essential", categorySlug: "mechanical-courses", name: "SolidWorks Essential", desc: "Rapid mechanical product prototyping.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "CATIA Essential", categorySlug: "mechanical-courses", name: "CATIA Essential", desc: "Designs complex aircraft geometry.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Ansys Workbench Essential", categorySlug: "mechanical-courses", name: "Ansys Workbench Essential", desc: "Simulates physical part stress.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Mastercam Essential", categorySlug: "mechanical-courses", name: "Mastercam Essential", desc: "Generates CNC machine G-code.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Ansys Fluent Essential", categorySlug: "mechanical-courses", name: "Ansys Fluent Essential", desc: "Simulates fluid airflow dynamics.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Autodesk Inventor Essential", categorySlug: "mechanical-courses", name: "Autodesk Inventor Essential", desc: "Designs sheet metal parts.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "CATIA Kinematics Essential", categorySlug: "mechanical-courses", name: "CATIA Kinematics Essential", desc: "Simulates dynamic mechanism motion.", duration: "24 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Creo Simulate Essential", categorySlug: "mechanical-courses", name: "Creo Simulate Essential", desc: "Detects stress points early.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "HyperMesh Essential", categorySlug: "mechanical-courses", name: "HyperMesh Essential", desc: "Generates crash simulation meshes.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "NX Nastran Essential", categorySlug: "mechanical-courses", name: "NX Nastran Essential", desc: "Calculates aircraft structural vibrations.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "NX CAM Essential", categorySlug: "mechanical-courses", name: "NX CAM Essential", desc: "Programs 5-axis CNC machines.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Reverse Engineering using CATIA Essential", categorySlug: "mechanical-courses", name: "Reverse Engineering using CATIA Essential", desc: "Reconstructs 3D scanned models.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "SolidWorks Motion Essential", categorySlug: "mechanical-courses", name: "SolidWorks Motion Essential", desc: "Calculates mechanical motor torque.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Non-Destructive Testing Essential", categorySlug: "mechanical-courses", name: "Non-Destructive Testing Essential", desc: "Inspects defects without damage.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in AutoCAD for Mechanical Engineers", categorySlug: "mechanical-courses", name: "Proficient in AutoCAD for Mechanical Engineers", desc: "Drafts 2D mechanical sheets.", duration: "40 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in Creo", categorySlug: "mechanical-courses", name: "Proficient in Creo", desc: "Advanced machinery component design.", duration: "80 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in SolidWork", categorySlug: "mechanical-courses", name: "Proficient in SolidWork", desc: "Advanced weldments and sheetmetal.", duration: "80 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in NX", categorySlug: "mechanical-courses", name: "Proficient in NX", desc: "High-end surface product modeling.", duration: "80 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in CATIA", categorySlug: "mechanical-courses", name: "Proficient in CATIA", desc: "Advanced aerospace body engineering.", duration: "80 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in CAE", categorySlug: "mechanical-courses", name: "Proficient in CAE", desc: "Optimizes structural safety margins.", duration: "80 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "Proficient in Ansys", categorySlug: "mechanical-courses", name: "Proficient in Ansys", desc: "Advanced multi-physics fluid calculations.", duration: "80 Hours", cat: "Civil", image: imgCivil,
  ...
  {
    slug: "PDMS Essential", categorySlug: "mep-courses", name: "PDMS Essential", desc: "Models database plant piping.", duration: "40 Hours", cat: "Elec", image: imgElec,
  ...
  {
    slug: "HVAC Design Essential", categorySlug: "mep-courses", name: "HVAC Design Essential", desc: "Sizes duct airflow networks.", duration: "40 Hours", cat: "BIM", image: imgRevit,
  ...
  {
    slug: "REVIT MEP Essential", categorySlug: "mep-courses", name: "REVIT MEP Essential", desc: "Integrates building utility networks.", duration: "40 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Proficient in MEP Design", categorySlug: "mep-courses", name: "Proficient in MEP Design", desc: "Complete building service planning.", duration: "40 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Proficient in HVAC and MEP Design", categorySlug: "mep-courses", name: "Proficient in HVAC and MEP Design", desc: "Leads end-to-end building services.", duration: "80 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Proficient in Piping Design", categorySlug: "mep-courses", name: "Proficient in Piping Design", desc: "Routes industrial pressure pipes.", duration: "40 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Primavera Project Planning and Management (Foundation)", categorySlug: "project-courses", name: "Primavera Project Planning and Management (Foundation)", desc: "Builds initial project baselines.", duration: "40 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Primavera Scheduling Professional (SPP)", categorySlug: "project-courses", name: "Primavera Scheduling Professional (SPP)", desc: "Tracks critical path schedules.", duration: "16 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Primavera Tracking Professional (TP)", categorySlug: "project-courses", name: "Primavera Tracking Professional (TP)", desc: "Tracks field delay variances.", duration: "16 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Primavera Application Administration (AA)", categorySlug: "project-courses", name: "Primavera Application Administration (AA)", desc: "Configures enterprise user permissions.", duration: "8 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Business Accounting and Taxation", categorySlug: "finance-courses", name: "Business Accounting and Taxation", desc: "Handles GST tax returns.", duration: "30 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Tally Prime Foundation", categorySlug: "finance-courses", name: "Tally Prime Foundation", desc: "Basic bookkeeping voucher entry.", duration: "40 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Tally Prime Advanced", categorySlug: "finance-courses", name: "Tally Prime Advanced", desc: "Manages payroll and inventory.", duration: "40 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Tally Prime Complete", categorySlug: "finance-courses", name: "Tally Prime Complete", desc: "Full corporate auditing skills.", duration: "80 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "AutoCAD Essential", categorySlug: "general-courses", name: "AutoCAD Essential", desc: "Reads basic 2D drawings.", duration: "40 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Proficient in CAD", categorySlug: "general-courses", name: "Proficient in CAD", desc: "Advanced systematic drafting techniques.", duration: "40 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "Proficient in QA/QC", categorySlug: "general-courses", name: "Proficient in QA/QC", desc: "Inspects job site quality.", duration: "96 Hours", cat: "Civil", image: imgStaad,
  ...
  {
    slug: "MS Excel (Basics)", categorySlug: "data-courses", name: "MS Excel (Basics)", desc: "Formats basic numeric tables.", duration: "8 Hours", cat: "IT", image: imgPython,
  ...
  {
    slug: "Advanced Excel", categorySlug: "data-courses", name: "Advanced Excel", desc: "Builds dynamic dashboard reports.", duration: "24 Hours", cat: "IT", image: imgFullStack,
  ...
  {
    slug: "Microsoft Power BI", categorySlug: "data-courses", name: "Microsoft Power BI", desc: "Visualizes interactive data analytics.", duration: "30 Hours", cat: "IT", image: imgDataScience,
  ...
  {
    slug: "Proficient in AutoCAD for Electrical & Electronics Engineers", categorySlug: "electrical-courses", name: "Proficient in AutoCAD for Electrical & Electronics Engineers", desc: "Drafts electrical panel schematics.", duration: "40 Hours", cat: "IT", image: imgPython,
  ...
  {
    slug: "Proficient in Electrical CAD", categorySlug: "electrical-courses", name: "Proficient in Electrical CAD", desc: "Designs automated PLC circuits.", duration: "40 Hours", cat: "IT", image: imgFullStack,
  ...
  {
    slug: "Certified Digital Marketing Program (Foundation)", categorySlug: "digital-courses", name: "Certified Digital Marketing Program (Foundation)", desc: "Promotes online business growth.", duration: "60 Hours", cat: "IT", image: imgPython,
