...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-25 right-7 z-40 h-14 w-14 rounded-full bg-whatsapp text-white shadow-[0_15px_40px_-10px_rgba(34,197,94,0.6)] flex items-center justify-center hover:scale-110 transition-transform"
    >
